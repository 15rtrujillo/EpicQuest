class Room:
    ...
    def __init__(self, id: int, name: str, desc: str, n: int = -1, ne: int = -1, e: int = -1, se: int = -1, s: int = -1, sw: int = -1, w: int = -1, nw: int = -1, up: int = -1, down: int = -1):
...
if __name__ == "__main__":
    """Dumps the Room class to a map file"""
    import json
    temp = Room(-1, "", "")
